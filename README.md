...
[![Methods Count](https://img.shields.io/badge/Methods%20count-core:%20704%20-e91e63.svg)](http://www.methodscount.com/?lib=io.michaelrocks%3Alibphonenumber-android%3A8.10.15)
...
dependencies {
  implementation 'io.michaelrocks:libphonenumber-android:8.10.15'
}
```
...
=======
 ...
 [2]: http://www.methodscount.com/?lib=com.googlecode.libphonenumber%3Alibphonenumber%3A8.10.15
