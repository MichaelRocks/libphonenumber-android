...
[![Methods Count](https://img.shields.io/badge/Methods%20count-core:%20558%20%7C%20deps:%20441-e91e63.svg)](http://www.methodscount.com/?lib=io.michaelrocks%3Alibphonenumber-android%3A7.4.1-2)
...
dependencies {
  compile 'io.michaelrocks:libphonenumber-android:7.4.2'
}
```
...
=======
 ...
 [2]: http://www.methodscount.com/?lib=com.googlecode.libphonenumber%3Alibphonenumber%3A7.4.1
